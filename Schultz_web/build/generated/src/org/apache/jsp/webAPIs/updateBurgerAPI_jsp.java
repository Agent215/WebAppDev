...
import model.burgers.*;
import com.google.gson.*;

public final class updateBurgerAPI_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (jsonUpdateData == null) {
        ...
        if (errorMsgs.errorMsg.length() == 0) { // means db connection is ok
            System.out.println("updateBurgers.jsp - ready to update");
